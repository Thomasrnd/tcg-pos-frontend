...
const OrderDetail = () => {
  ...
  const verifyPaymentMutation = useMutation(
    () => orderService.verifyPayment(id),
    {
      ...
      // Continuation of src/pages/admin/OrderDetail.js
    },
  }
);
            ...
            <div>
              ...
              <Card title="Actions">
                <div className="space-y-2">
                  ...
                  {order.paymentMethod === 'BANK_TRANSFER' && order.status === 'PAYMENT_UPLOADED' && (
                    <Button
                      variant="primary"
                      className="w-full"
                    ...
                    >
                      {verifyPaymentMutation.isLoading ? 'Processing...' : 'Verify Payment'}
                    </Button>
                  )}
